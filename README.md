...
## Как улучшить вашу успеваемость
...
```
Запустите сайт с помощью команды `python3 manage.py runserver`

При необходимости совершите миграции командой `python3 manage.py migrate`

Создайте новое окно терминала и запустите в нём shell командой `python3 manage.py shell`

Совершите импорт необходимых моделей

`
from datacenter.models import Schoolkid, Mark, Subject, Lesson, Chastisement, Commendation
`

Скопируйте в терминал с shell любую функцию

Примените её, указав нужные вам данные

![Screenshot from 2024-12-18 18-53-05](https://github.com/user-attachments/assets/3080bd67-d5d6-4ee3-b922-1e0cf856f0c0)

Обновите сайт и проверьте внесённые вами изменения
